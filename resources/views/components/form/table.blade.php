        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    @if ($keys == 'delete')
                    <a href="{{ Route($items, $item['id']) }}" class="confirmdelete"><i class="fas fa-trash-alt"></i>&nbsp;</a>
                    @elseif ($keys == 'edit')
                    <a href="{{ Route($items, $item['id']) }}"><i class="fas fa-edit"></i>&nbsp;</a>
                    @elseif ($keys == 'view')
                    <a href="{{ Route($items, $item['id']) }}"><i class="fas fa-eye"></i>&nbsp;</a>
                    @elseif ($keys == 'pdf')
                    <a href="{{ Route($items, $item['id']) }}"><i class="fas fa-file-pdf"></i>&nbsp;</a>
                    @elseif ($keys == 'url')
                    <a href="{{ Route($items, $item['name']) }}" target="_blank"><i class="fas fa-link"></i></a>
                    @elseif ($keys == 'users')
                    <a href="{{ Route($items, $item['id']) }}"><i class="fas fa-users-medical"></i>&nbsp;</a>
                    @endif
                    @endforeach
                </td>
                @else
